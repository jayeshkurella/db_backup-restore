...
import { UnidentifiedBodiesApiService } from '../unidentified-bodies/unidentified-bodies-api.service';
...
export class UnidentifiedPersonComponent implements OnInit {
  ...
  constructor(private missingPersonService: UnidnetifiedPersonApiService) {}
  filters = {
    full_name :'',
    city: '',
    state: '',
