# Generated by Django 5.1.3 on 2025-03-10 11:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blood_group', models.CharField(blank=True, choices=[('O', 'O'), ('A', 'A'), ('B', 'B'), ('AB', 'AB')], db_index=True, max_length=5, null=True)),
        ...
        migrations.AddIndex(
            model_name='person',
            index=models.Index(fields=['match_entity_id', 'match_with'], name='Mainapp_per_match_e_62d184_idx'),
        ),
