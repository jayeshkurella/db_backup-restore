    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('PERMANENT', 'Permanent'), ('CURRENT', 'Current'), ('OLD', 'Old'), ('HOME', 'Home'), ('OFFICE', 'Office')], db_index=True, max_length=10)),
                ...
                ('country', models.CharField(choices=[('India', 'India'), ('United States of America', 'United States of America'), ('China', 'China'), ('Japan', 'Japan'), ('Germany', 'Germany'), ('United Kingdom', 'United Kingdom'), ('France', 'France'), ('Brazil', 'Brazil'), ('Australia', 'Australia'), ('Canada', 'Canada'), ('Russia', 'Russia'), ('Italy', 'Italy'), ('South Korea', 'South Korea'), ('Mexico', 'Mexico'), ('South Africa', 'South Africa'), ('Indonesia', 'Indonesia'), ('Saudi Arabia', 'Saudi Arabia'), ('Turkey', 'Turkey'), ('Spain', 'Spain'), ('Netherlands', 'Netherlands')], db_index=True, default='India', help_text='Country code or ID', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('type', models.CharField(choices=[('Missing Person', 'Missing Person'), ('Unidentifed Person', 'Unidentifed Person'), ('Unidentified Body', 'Unidentified Body')], db_index=True, max_length=20)),
                ...
                ('blood_group', models.CharField(blank=True, choices=[('O', 'O'), ('A', 'A'), ('B', 'B'), ('AB', 'AB')], db_index=True, max_length=2, null=True)),
                ...
                ('photo_upload', models.ImageField(blank=True, null=True, upload_to='All_Photos/persons_photos/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('user_type', models.CharField(choices=[('reporting', 'Reporting'), ('volunteer', 'Volunteer'), ('family', 'Family'), ('admin', 'Admin'), ('sub-admin', 'Sub-Admin'), ('officer', 'Officer'), ('police_station', 'Police Station'), ('hospital', 'Hospital'), ('Developer', 'Developer')], default='reporting', max_length=20)),
                ('sub_user_type', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('person_photo', models.ImageField(blank=True, help_text='URL or Base64 encoded photo of the person', null=True, upload_to='')),
                ('reference_photo', models.ImageField(blank=True, help_text='URL or Base64 encoded reference photo', null=True, upload_to='')),
                ('missing_time', models.TimeField(blank=True, help_text='Exact time the person was last seen', null=True)),
                ('missing_date', models.DateTimeField(blank=True, help_text='Date the person went missing', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('fir_no', models.CharField(blank=True, help_text='Unique FIR number', max_length=50, null=True)),
                ('case_status', models.CharField(blank=True, help_text='Current status of the case', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_type', models.CharField(blank=True, choices=[('aadhar', 'Aadhar'), ('pan', 'PAN'), ('dl', 'Driving License'), ('passport', 'Passport')], max_length=10, null=True)),
                ('id_no', models.CharField(help_text='Unique identification number', max_length=50)),
        ...
        migrations.AddIndex(
            model_name='person',
            index=models.Index(fields=['photo_upload', 'distinctive_mark', 'birth_mark', 'Body_Condition'], name='Mainapp_per_photo_u_816075_idx'),
        ),
        migrations.AddIndex(
            model_name='person',
        ...
        migrations.AddIndex(
            model_name='address',
            index=models.Index(fields=['type', 'city', 'state', 'pincode'], name='Mainapp_add_type_e00e8a_idx'),
        ),
        migrations.AddIndex(
            model_name='address',
