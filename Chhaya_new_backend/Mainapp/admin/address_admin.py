...
class AddressAdmin(LeafletGeoAdmin):
    list_display = ('sr_no', 'address_type','person_type', 'city', 'state', 'pincode', 'country', 'is_active', 'created_at', 'updated_at')
    ...
    fieldsets = (
        ('Basic Information', {'fields': ('address_type','person_type', 'is_active')}),
