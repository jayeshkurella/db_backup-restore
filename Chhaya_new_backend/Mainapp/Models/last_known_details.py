...
class LastKnownDetails(models.Model):
    ...
    person_photo = models.TextField(blank=True, null=True, help_text="URL or Base64 encoded photo of the person")
    reference_photo = models.TextField(blank=True, null=True, help_text="URL or Base64 encoded reference photo")
